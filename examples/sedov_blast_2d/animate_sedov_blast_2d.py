"""
Animate the result of Sedov-Taylor blast test

Usage:
    python animate_sedov_blast_2d.py
...
FILE_PATH = Path(__file__).parent / "sedov_blast_2d.gif"
...
def main() -> None:
    ...
    for i, snapshot_file in enumerate(snapshot_files):
        with h5py.File(snapshot_file, "r") as f:
            ...
            plt.xlabel("x")
            plt.ylabel("y")
            plt.title(f"Sedov blast 2D (t={t:.2f})")

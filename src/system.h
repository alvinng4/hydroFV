...
typedef struct System
{
    ...
    double dy_;
    double dz_;
    double *interface_density_x_L_;
    double *interface_density_x_R_;
    double *interface_density_y_B_;
    double *interface_density_y_T_;
    double *interface_density_z_B_;
    double *interface_density_z_F_;
    double *interface_velocity_x_x_L_;
    double *interface_velocity_x_x_R_;
    double *interface_velocity_x_y_L_;
    double *interface_velocity_x_y_R_;
    double *interface_velocity_x_z_L_;
    double *interface_velocity_x_z_R_;
    double *interface_velocity_y_x_B_;
    double *interface_velocity_y_x_T_;
    double *interface_velocity_y_y_B_;
    double *interface_velocity_y_y_T_;
    double *interface_velocity_y_z_B_;
    double *interface_velocity_y_z_T_;
    double *interface_velocity_z_x_B_;
    double *interface_velocity_z_x_F_;
    double *interface_velocity_z_y_B_;
    double *interface_velocity_z_y_F_;
    double *interface_velocity_z_z_B_;
    double *interface_velocity_z_z_F_;
    double *interface_pressure_x_L_;
    double *interface_pressure_x_R_;
    double *interface_pressure_y_B_;
    double *interface_pressure_y_T_;
    double *interface_pressure_z_B_;
    double *interface_pressure_z_F_;
    double *density_;
    double *velocity_x_;
    double *velocity_y_;
    double *velocity_z_;
